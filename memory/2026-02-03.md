...
## Session (evening, ~18:05 UTC)

### Jason问小红书爬虫技术
- 问我们之前找的第三方工具用什么方式绕过小红书限制
- 我从memory和项目文件中找到了3个工具的信息：

**1. MediaCrawler（NanmiCoder）**
- Playwright + Cookie登录
- 无头浏览器模拟真实用户
- setup脚本在 chinese-social-scripts/setup-mediacrawler.sh

**2. XHS-Downloader（⭐9.9k）**
- 浏览器插件 + WebSocket
- 拦截真实请求，不需要逆向签名

**3. xhs-web-sign（⭐21）**
- JS逆向x-s/x-t签名算法
- 需要Node.js，签名算法经常更新容易失效

**小红书限制核心：**
- 登录验证（Cookie）
- 请求签名（x-s/x-t动态参数）
- 绕过方式：模拟浏览器 / 拦截真实请求 / 逆向签名

### 待确认
- Jason可能想用这些工具抓取数据做素材库
- 还没说具体用途，等他回复
